      ...
      <div className="space-y-4">
        ...
        <div className="bg-white border-b border-gray-200 -mx-4 sm:-mx-6 px-4 sm:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold leading-none">Analytics & Insights</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent outline-none bg-white"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="rounded-2xl border border-gray-200 bg-white p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className="text-xs text-gray-500">Overall Mood</div>
            </div>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className="text-xs text-gray-500">Positive Trend</div>
            </div>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className="text-xs text-gray-500">Avg Entries/Day</div>
            </div>
