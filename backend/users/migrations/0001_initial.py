    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mental_health_concerns', models.JSONField(blank=True, default=list)),
                ('mood_tracking_goals', models.JSONField(blank=True, default=list)),
                ('preferred_checkin_time', models.CharField(blank=True, max_length=20)),
